    ...
    <div className={compact ? "flex flex-col gap-2" : "grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5"}>
      {CARDS.map((card, i) => (
        ...
        >
          ...
          {compact ? (
            <div className="relative w-[42%] shrink-0 overflow-hidden">
              <Image
                ...
                className={
                  card.category === "ozone"
                    ? "scale-[1.3] object-cover object-[41%_41%] transition-transform duration-700 group-hover:scale-[1.35]"
                    : "scale-[1.0] object-cover object-[38%_37%] transition-transform duration-700 group-hover:scale-[1.05]"
                }
              />
          ...
          {compact ? (
            <div className="flex flex-1 items-center justify-between gap-2 px-5 py-2">
              <h3 className="font-display text-[17px] font-bold uppercase tracking-wide text-ink">{card.title}</h3>
